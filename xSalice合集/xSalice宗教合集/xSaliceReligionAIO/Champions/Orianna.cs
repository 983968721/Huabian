    ...
    class Orianna : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            { 
                ...
                key.AddItem(new MenuItem("LastHitQQ", "使用 Q 补刀", true).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("escape", "使用 E 逃跑!", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spellMenu = new Menu("技能 菜单", "SpellMenu");
            {
                ...
                //W
                var wMenu = new Menu("W技能", "WSpell");
                {
                    wMenu.AddItem(new MenuItem("autoW", "自动W丨敌人数量", true).SetValue(new Slider(2, 1, 5)));
                    spellMenu.AddSubMenu(wMenu);
                }
                //E
                var eMenu = new Menu("E 技能", "ESpell");
                {
                    eMenu.AddItem(new MenuItem("UseEDmg", "使用 E 保护", true).SetValue(true));

                    eMenu.AddSubMenu(new Menu("使用 E 保护队友", "shield"));
                    eMenu.SubMenu("shield").AddItem(new MenuItem("eAllyIfHP", "E保护|队友血量", true).SetValue(new Slider(40)));
                ...
                var rMenu = new Menu("R 技能", "RSpell"); 
                {
                    ...
                    rMenu.AddItem(new MenuItem("killR", "手动 R", true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Toggle)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("autoRCombo", "使用R|敌方人数", true).SetValue(new Slider(2, 1, 5)));
            ...
            var farm = new Menu("清线", "Farm");
            {
                ...
                farm.AddItem(new MenuItem("qFarm", "使用Q/W补兵|小兵数量大于", true).SetValue(new Slider(3, 0, 5)));
            ...
            //Damage after combo:
            MenuItem dmgAfterComboItem = new MenuItem("DamageAfterCombo", "显示组合连招伤害", true).SetValue(true);
            ...
            var drawing = new Menu("范围", "Drawings"); { 
                ...
                drawing.AddItem(new MenuItem("rModeDraw", "R 调式", true).SetValue(new Circle(true, Color.FromArgb(100, 255, 0, 255))));
