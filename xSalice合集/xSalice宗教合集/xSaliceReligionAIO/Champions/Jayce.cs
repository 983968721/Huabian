    ...
    class Jayce : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            { 
                ...
                key.AddItem(new MenuItem("shootMouse", "EQ鼠标方向", true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }
            ...
            { 
                ...
                combo.AddItem(new MenuItem("UseECombo", "使用 炮形态 E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseQComboHam", "使用 锤形态 Q", true).SetValue(true));
                combo.AddItem(new MenuItem("UseWComboHam", "使用 锤形态 W", true).SetValue(true));
                combo.AddItem(new MenuItem("UseEComboHam", "使用 锤形态 E", true).SetValue(true));
            ...
            var drawMenu = new Menu("范围", "Drawings");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_E", "显示 E 炮形", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_Q2", "显示 Q 锤形", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E2", "显示 E 锤形", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("drawcds", "显示技能冷却", true).SetValue(true));
