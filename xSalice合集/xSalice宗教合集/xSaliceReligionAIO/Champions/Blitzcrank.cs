    ...
    class Blitzcrank : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("键位", "Keys"); 
            {
                ...
                key.AddItem(new MenuItem("panic", "逃跑(没蓝)",true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("QE", "使用 E 被突进时",true).SetValue(true));
