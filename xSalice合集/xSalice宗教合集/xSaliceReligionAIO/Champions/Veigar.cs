    ...
    class Veigar : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("键位", "Keys");
            {
                ...
                key.AddItem(new MenuItem("LastHitQQ", "Q丨最后一下", true).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("LastHitQQ2", "自动丨Q最后一下", true).SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("wPoke", "使用W丨尽在对面眩晕时", true).SetValue(new KeyBind("N".ToCharArray()[0], KeyBindType.Toggle)));
            ...
            {
                combo.AddItem(new MenuItem("selected", "寻找 重点目标", true).SetValue(true));
                ...
                combo.AddItem(new MenuItem("waitW", "先E后W", true).SetValue(true));
                ...
                combo.AddItem(new MenuItem("DFGMode", "冥火模式", true).SetValue(new StringList(new[] {"Combo", "DFG-R"})));
            ...
            var misc = new Menu("杂项", "Misc"); 
            {
                ...
                misc.AddSubMenu(new Menu("禁止使用R", "DontUlt"));
                ...
                misc.AddSubMenu(new Menu("禁止对某人 使用 DFG", "DontDFG"));
            ...
            { 
               ...
               drawing.AddItem(new MenuItem("manaStatus", "蓝量 状态", true).SetValue(true));
