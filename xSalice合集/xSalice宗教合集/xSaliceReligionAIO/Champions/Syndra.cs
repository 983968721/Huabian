    ...
    class Syndra : Champion
    {
        ...
        private void LoadMenu()
        {
            var key = new Menu("键位", "Key");
            {
                ...
                key.AddItem(new MenuItem("Misc_QE_Mouse", "QE 鼠标方向", true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("forceR", "强行击杀丨选择最好的目标", true).SetValue(new KeyBind("R".ToCharArray()[0], KeyBindType.Press)));
            ...
            var spellMenu = new Menu("技能 菜单", "SpellMenu");
            {
                ...
                {
                    wMenu.AddItem(new MenuItem("W_Only_Orb", "只捡起地上球W", true).SetValue(false));
                    spellMenu.AddSubMenu(wMenu);
                }
                var rMenu = new Menu("R 技能", "RMenu");
                {
                    rMenu.AddItem(new MenuItem("R_Overkill_Check", "击杀提示", true).SetValue(true));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("UseQECombo", "使用 QE", true).SetValue(true));
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("UseQEHarass", "使用 QE", true).SetValue(true));
            ...
            {
                miscMenu.AddItem(new MenuItem("QE_Interrupt", "使用 QE 中断法术", true).SetValue(true));
                miscMenu.AddItem(new MenuItem("E_Gap_Closer", "使用 E 防止突进", true).SetValue(true));
                miscMenu.AddItem(new MenuItem("smartKS", "使用 智能抢人头", true).SetValue(true));
            ...
            var drawMenu = new Menu("范围", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_Q", "Q 发明屋", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_QE", "QE 范围", true).SetValue(true));
                ...
                drawMenu.AddItem(new MenuItem("Draw_QE_Line", "显示 QE 路径", true).SetValue(true));
