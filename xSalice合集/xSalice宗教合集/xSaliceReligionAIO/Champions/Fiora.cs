    ...
    class Fiora : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("技能 菜单", "SpellMenu");
            {
                ...
                {
                    qMenu.AddItem(new MenuItem("Q_Min_Distance", "使用Q最小范围",true).SetValue(new Slider(300, 0, 600)));
                    qMenu.AddItem(new MenuItem("Q_Gap_Close", "使用Q突进",true).SetValue(true));
                ...
                {
                    eMenu.AddItem(new MenuItem("E_Reset", "E 自动开启", true).SetValue(true));
                    spellMenu.AddSubMenu(eMenu);
                }

                var rMenu = new Menu("R 技能", "RMenu");
                {
                    rMenu.AddItem(new MenuItem("R_If_HP", "使用R|自己血量", true).SetValue(new Slider(20)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("Combo_mode", "连招 模式",true).SetValue(new StringList(new[] { "Normal", "Q-AA-Q-AA-Ult" })));
            ...
            var farm = new Menu("清线", "LaneClear");
            {
                ...
                farm.AddItem(new MenuItem("UseQFarm_Tower", "塔下禁用Q",true).SetValue(true));
            ...
            var drawMenu = new Menu("范围", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_R_Killable", "显示R击杀",true).SetValue(true));
