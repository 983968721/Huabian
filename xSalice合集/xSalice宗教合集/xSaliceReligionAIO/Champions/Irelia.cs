    ...
    class Irelia : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("技能 菜单", "SpellMenu");
            {
                ...
                {
                    qMenu.AddItem(new MenuItem("Q_Min_Distance", "最小Q范围", true).SetValue(new Slider(300, 0, 600)));
                    qMenu.AddItem(new MenuItem("Q_Gap_Close", "最小Q突进范围", true).SetValue(true));
                    qMenu.AddItem(new MenuItem("Q_Under_Tower", "敌人在塔下自动Q", true).SetValue(false));
                    spellMenu.AddSubMenu(qMenu);
                }

                var eMenu = new Menu("E 技能", "EMenu");
                {
                    eMenu.AddItem(new MenuItem("E_Only_Stun", "使用E击晕", true).SetValue(true));
                    eMenu.AddItem(new MenuItem("E_Running", "对逃跑的敌人击晕", true).SetValue(true));
            ...
            var farm = new Menu("清线", "LaneClear");
            {
                ...
                farm.AddItem(new MenuItem("UseQFarm_Tower", "禁用塔下Q", true).SetValue(true));
            ...
            var miscMenu = new Menu("杂项", "Misc");
            {
                ...
                miscMenu.AddItem(new MenuItem("QE_Interrupt", "使用 Q/E 打断技能", true).SetValue(true));
                //add to menu
            ...
            var drawMenu = new Menu("范围", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_R_Killable", "显示R可杀目标", true).SetValue(true));
