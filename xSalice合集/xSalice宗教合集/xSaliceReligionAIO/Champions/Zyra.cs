    ...
    class Zyra : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("R_Min", "R 敌人数量, 6 = 关", true).SetValue(new Slider(3, 1, 6)));
                //add to menu
            ...
            var misc = new Menu("杂项", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("Auto_Bloom", "敌人接近 自动W  ", true).SetValue(true));
                //add to menu
            ...
            {
                drawing.AddItem(new MenuItem("Draw_Disabled", "禁用 所有", true).SetValue(false));
                drawing.AddItem(new MenuItem("Draw_Q", "Q 范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_W", "W 范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_E", "E 范围", true).SetValue(true));
                drawing.AddItem(new MenuItem("Draw_R", "R 范围", true).SetValue(true));
