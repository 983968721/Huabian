    ...
    class Azir : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("键位", "Key");
            {
                ...
                key.AddItem(new MenuItem("insec", "R 目标选择",true).SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("qeCombo", "Q->E 突进目标",true).SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("qMulti", "两个使用使用Q",true).SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
            ...
            //Spell Menu
            var spell = new Menu("技能 菜单", "Spell");
            {
                ...
                var qMenu = new Menu("Q 技能", "QSpell"); {
                    ...
                    qMenu.AddItem(new MenuItem("qHit", "Q 命中率", true).SetValue(new Slider(3, 1, 3)));
                    spell.AddSubMenu(qMenu);
                }
                //W Menu
                var wMenu = new Menu("W 技能", "WSpell"); {
                    wMenu.AddItem(new MenuItem("wAtk", "自动攻击敌人", true).SetValue(true));
                    wMenu.AddItem(new MenuItem("wQ", "使用 WQ Poke", true).SetValue(true));
            ...
            var killSteal = new Menu("抢人头", "KillSteal");
            {
                ...
                killSteal.AddItem(new MenuItem("wqKS", "使用 W 抢人头",true).SetValue(true));
