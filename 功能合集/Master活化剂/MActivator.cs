...
namespace MasterActivator
{
    internal class MActivator
    {
        ...
        MItem bilgewater = new MItem("BilgewaterCutlass", "比尔吉沃特弯刀", "bilge", 3144, ItemTypeId.Offensive, 450);
        MItem king = new MItem("ItemSwordOfFeastAndFamine", "破败王者之刃", "king", 3153, ItemTypeId.Offensive, 450);
        MItem youmus = new MItem("Youmuu's Ghostblade", "幽梦之灵", "youmus", 3142, ItemTypeId.Offensive);
        MItem tiamat = new MItem("ItemTiamatCleave", "提亚玛特", "tiamat", 3077, ItemTypeId.Offensive, 400);
        MItem hydra = new MItem("Ravenous Hydra", "九头蛇", "hydra", 3074, ItemTypeId.Offensive, 400);
        MItem dfg = new MItem("DeathfireGrasp", "冥火之拥", "dfg", 3128, ItemTypeId.Offensive, 750);
        MItem divine = new MItem("ItemSoTD", "神圣之剑", "divine", 3131, ItemTypeId.Offensive); //Sword of the Divine
        MItem hextech = new MItem("Hextech Gunblade", "海克斯科技枪", "hextech", 3146, ItemTypeId.Offensive, 700);
        MItem muramana = new MItem("Muramana", "Muramana", "魔宗利刃", 3042, ItemTypeId.Buff);
        MItem seraph = new MItem("ItemSeraphsEmbrace", "炽天使之拥", "seraph", 3040, ItemTypeId.Deffensive);
        MItem zhonya = new MItem("Zhonya's Hourglass", "中亚沙漏", "zhonya", 3157, ItemTypeId.Deffensive);
        ...
        MItem mountain = new MItem("Face of the Mountain", "山岳之融", "mountain", 3401, ItemTypeId.Deffensive, 700); // falta range
        MItem frost = new MItem("Frost Queen's Claim", "冰霜女王的指令", "frost", 3092, ItemTypeId.OffensiveAOE, 850);
        MItem solari = new MItem("Locket of the Iron Solari", "钢铁烈阳之匣", "solari", 3190, ItemTypeId.Deffensive, 600);
        MItem mikael = new MItem("Mikael's Crucible", "米卡尔的坩埚", "mikael", 3222, ItemTypeId.Purifier, 750);
        ...
        MItem clarity = new MItem("Clarity", "清晰术", "SummonerMana", 0, ItemTypeId.ManaRegeneratorSpell, 600);
        ...
        MItem smiteAOE = new MItem("SmiteAOE", "紫色 惩戒", "itemsmiteaoe", 0, ItemTypeId.OffensiveSpell, 750);
        MItem smiteDuel = new MItem("SmiteDuel", "红色 惩戒", "s5_summonersmiteduel", 0, ItemTypeId.OffensiveSpell, 750);
        MItem smiteQuick = new MItem("SmiteQuick", "灰色 惩戒", "s5_summonersmitequick", 0, ItemTypeId.OffensiveSpell, 750);
        MItem smiteGanker = new MItem("SmiteGanker", "蓝色 惩戒", "s5_summonersmiteplayerganker", 0, ItemTypeId.OffensiveSpell, 750);

        // Auto shields 
        MItem blackshield = new MItem("BlackShield", "黑暗之盾", "bShield", 0, ItemTypeId.TeamAbility, 750, SpellSlot.E); //Morgana
        MItem unbreakable = new MItem("BraumE", "坚不可摧", "unbreak", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.E);
        MItem palecascade = new MItem("DianaOrbs", "苍白之瀑", "cascade", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W);
        MItem bulwark = new MItem("GalioBulwark", "保护壁垒", "bulwark", 0, ItemTypeId.TeamAbility, 800, SpellSlot.W);
        MItem courage = new MItem("GarenW", "勇气", "courage", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W);
        MItem eyeofstorm = new MItem("EyeOfTheStorm", "风暴之眼", "storm", 0, ItemTypeId.Ability, 800, SpellSlot.E); //Janna
        MItem inspire = new MItem("KarmaSolKimShield", "鼓舞", "inspire", 0, ItemTypeId.TeamAbility, 800, SpellSlot.E);
        MItem helppix = new MItem("LuluE", "帮助 皮克斯!", "pix", 0, ItemTypeId.TeamAbility, 650, SpellSlot.E);
        MItem prismaticbarrier = new MItem("LuxPrismaticWave", "曲光屏障", "pBarrier", 0, ItemTypeId.TeamAbility, 1075, SpellSlot.W);
        MItem titanswraith = new MItem("NautilusPiercingGaze", "泰坦之怒", "tWraith", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W);
        MItem commandprotect = new MItem("OrianaRedactCommand", "指令：防卫", "cProt", 0, ItemTypeId.TeamAbility, 1100, SpellSlot.E);
        MItem feint = new MItem("ShenFeint", "佯攻", "feint", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W); // ?
        MItem spellshield = new MItem("SivirE", "法术护盾", "sShield", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.E);
        MItem nocturneShield = new MItem("NocturneShroudOfDarkness", "黑暗庇护", "nShield", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W);
        MItem yasuoShield = new MItem("YasuoWMovingWall", "亚索 风墙", "yShield", 0, ItemTypeId.TeamAbilityAOE, 400, SpellSlot.W);
        MItem fioraRiposte = new MItem("FioraRiposte", "剑姬 反击", "fRiposte", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W);// S2 fiora
        MItem tryndaUlt = new MItem("UndyIngrage", "蛮子 大招.", "tIngrage", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.R);// Trynda mia ult
        MItem nasusUlt = new MItem("NasusR", "内瑟斯 大招.", "nasusR", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.R);
        MItem renekUlt = new MItem("RenektonReignOfTheTyrant", "鳄鱼 大招.", "renekR", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.R); //Renek nek
        MItem leonaW = new MItem("LeonaSolarBarrier", "曙光 日蚀", "leonaW", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W);
        MItem annieE = new MItem("MoltenShield", "安妮 熔岩护盾", "annieE", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.E); // Annie
        MItem vladW = new MItem("VladimirSanguinePool", "吸血鬼 血池", "vladW", 0, ItemTypeId.Ability, int.MaxValue, SpellSlot.W); // nigga VladImir W
        ...
        MMinion dragon = new MMinion("SRU_Dragon", "小龙buff", 6, 143);
        MMinion baron = new MMinion("SRU_Baron", "大龙buff", -18, 192);
        MMinion wolf = new MMinion("SRU_Murkwolf", "三狼buff", 41, 74);
        MMinion razor = new MMinion("SRU_Razorbeak", "F4buff", 39, 74); // Ghosts
        MMinion krug = new MMinion("SRU_Krug", "蛤蟆buff", 38, 80);
        MMinion crab = new MMinion("Sru_Crab", "螃蟹buff", 43, 62);
        MMinion gromp = new MMinion("SRU_Gromp", "石头人buff", 32, 87); // Ghost

        MMinion tVilemaw = new MMinion("TT_Spiderboss", "F4", 45, 67);
        MMinion tWraith = new MMinion("TT_NWraith", "幽灵", 45, 67);
        MMinion tGolem = new MMinion("TT_NGolem", "石头人", 45, 67);
        MMinion tWolf = new MMinion("TT_NWolf", "狼", 45, 67);
        ...
        {
            // Boas vindas
            Game.PrintChat("<font color='#3BB9FF'>MasterActivator - by Crisdmc - Loaded</font>涓ㄦ眽鍖朆y 鑺辫竟");
            ...
            {
                Game.PrintChat("MasterActivator error creating menu!涓ㄦ眽鍖朆y 鑺辫竟");
            }
        }
        ...
        private void createMenuItem(MItem item, String parent, int defaultValue = 0, bool mana = false, int minManaPct = 0)
        {
            if (item.type == ItemTypeId.Ability || item.type == ItemTypeId.TeamAbility || item.type == ItemTypeId.TeamAbilityAOE)
            {
                ...
                if (abilitySlot != SpellSlot.Unknown && abilitySlot == item.abilitySlot)
                {
                    ...
                    menu.AddItem(new MenuItem(item.menuVariable + "UseOnPercent", "使用时 HP= %")).SetValue(new Slider(defaultValue, 0, 100));
                    if (minManaPct > 0)
                    {
                        menu.AddItem(new MenuItem(item.menuVariable + "UseManaPct", "最小 蓝量= %")).SetValue(new Slider(minManaPct, 0, 100));
                    }
            ...
            else
            {
                ...
                if (defaultValue != 0)
                {
                    ...
                    {
                        menu.AddItem(new MenuItem(item.menuVariable + "UseXUnits", "使用对象 数量")).SetValue(new Slider(defaultValue, 1, 5));
                    }
                    else
                    {
                        menu.AddItem(new MenuItem(item.menuVariable + "UseOnPercent", "使用 " + (mana == false ? "%最低血量" : "%最低蓝量"))).SetValue(new Slider(defaultValue, 0, 100));
                    }
                }
                Config.SubMenu(parent).AddSubMenu(menu);
            }
        ...
        {
            Config = new Menu("花边汉化-活化剂", "masterActivator", true);
            ...
            Config.SubMenu("purifiers").AddItem(new MenuItem("defJustOnCombo", "在连招时使用")).SetValue(false);
            ...
            Config.SubMenu("purify").AddItem(new MenuItem("snare", "束缚")).SetValue(true);
            ...
            Config.SubMenu("purify").AddItem(new MenuItem("dehancer", "冰冻")).SetValue(false);
            Config.SubMenu("purify").AddItem(new MenuItem("zedultexecute", "劫 大招")).SetValue(true);
            ...
            var menuSmiteMobs = new Menu("大野怪", "smiteMobs");
            if (Utility.Map.GetMap().Type.Equals(Utility.Map.MapType.TwistedTreeline))
            {
                ...
                menuSmiteMobs.AddItem(new MenuItem("TT_NGolem", "石头人")).SetValue(true);
                menuSmiteMobs.AddItem(new MenuItem("TT_NWolf", "狼")).SetValue(true);
            }
            else
            {
            ...
            var menuSmiteDraw = new Menu("范 围", "smiteDraw");
            menuSmiteDraw.AddItem(new MenuItem("dSmite", "开 启")).SetValue(true);
            menuSmiteDraw.AddItem(new MenuItem("justAS", "选定 惩戒目标")).SetValue(false);
            ...
            Config.AddSubMenu(new Menu("关闭AOE", "offAOE"));
            ...
            Config.SubMenu("deffensive").AddItem(new MenuItem("justPred", "预 测")).SetValue(true);
            Config.SubMenu("deffensive").AddItem(new MenuItem("useRecalling", "使用 回城")).SetValue(false);
            ...
            Config.SubMenu("regenerators").SubMenu("menu" + heal.menuVariable).AddItem(new MenuItem("useWithHealDebuff", "使用 debuff")).SetValue(true);
            Config.SubMenu("regenerators").SubMenu("menu" + heal.menuVariable).AddItem(new MenuItem("justPredHeal", "预 测")).SetValue(false);
            ...
            Config.AddSubMenu(new Menu("团队 使用", "teamUseOn"));
            ...
            Config.SubMenu("combo").AddItem(new MenuItem("comboModeActive", "启 用")).SetValue(new KeyBind(32, KeyBindType.Press, true));

            // Target selector
            Config.AddSubMenu(new Menu("目标 选择", "targetSelector"));
            TargetSelector.AddToMenu(Config.SubMenu("targetSelector"));

            Config.AddItem(new MenuItem("predict", "预判 DMG(伤害)")).SetValue(true);
            //Config.AddItem(new MenuItem("enabled", "Enabled")).SetValue(true);
            //38
            Config.AddItem(new MenuItem("enabled", "使用活化剂!")).SetValue(new KeyBind('L', KeyBindType.Toggle, true));
