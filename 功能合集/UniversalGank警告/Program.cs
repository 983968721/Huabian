...
namespace UniversalGankAlerter
{
    internal class Program
    {
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            _menu = new Menu("花边汉化-Gank警告", "universalgankalerter", true);
            ...
            _sliderCooldown = new MenuItem("cooldown", "冷却 时间 (秒)").SetValue(new Slider(10, 0, 60));
            ...
            _junglerOnly = new MenuItem("jungleronly", "只警惕 打野").SetValue(false);
