...
namespace Tracker
{
    ...
    public static class HbTracker
    {
        ...
        {
            Config = menu.AddSubMenu(new Menu("技能 CD", "CD Tracker"));
            Config.AddItem(new MenuItem("TrackAllies", "显示 队友").SetValue(true));
            Config.AddItem(new MenuItem("TrackEnemies", "显示 敌人").SetValue(true));
            Config.AddItem(new MenuItem("TrackMe", "显示 自己").SetValue(false));
        }
