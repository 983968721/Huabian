...
namespace Killability
{
    ...
    internal class KillDrawer
    {
        ...
        public KillDrawer()
        {
            ...
            _config.AddItem(new MenuItem("icon", "显示 图标").SetValue(true));
            _config.AddItem(new MenuItem("text", "显示 文本").SetValue(true));
            _config.AddToMainMenu();

            InitDrawing();

            Game.PrintChat("鍑绘潃鎻愮ず by h3h3 鍔犺級鎴愬姛锛佹饥鍖朾y浜岀嫍  浜岀嫍QQ缇361630847.");
        }
