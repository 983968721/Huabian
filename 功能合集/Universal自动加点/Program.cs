...
namespace UniversalLeveler
{
    internal static class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            _activate = new MenuItem("activate", "启用 等级").SetValue(new StringList(new[] { "2", "3" }));
        ...
        private static void ParseMenu()
        {
            ...
            if (!format)
            {
                Print("Menu values are <font color='#FF0000'>No!错误!</font>!");
                _priority = null;
            ...
            else
            {
                ...
                {
                    Print("Menu values are <font color='#008000'>Yes!正确!</font>!");
                }
