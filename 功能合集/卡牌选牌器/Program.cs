...
namespace CardSelector
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
			...
			Config = new Menu("花边汉化-单独选牌器", "Card Selector", true);
			
			Config.AddSubMenu(new Menu("卡牌 选择", "CardSelector"));
			...
			Config.SubMenu("CardSelector").AddItem(new MenuItem("Ping", "本地提醒低血量敌人").SetValue(true));
			...
			Game.PrintChat("花边汉化-单独选牌器 加载成功!!");
