...
namespace KaiHelper.Misc
{
    internal class Vision
    {
        ...
        {
            _menu = menu.AddSubMenu(new Menu("敌人 视野", "Enemyvision"));
            _menu.AddItem(new MenuItem("VongTron", "只有 圈圈").SetValue(false));
            _menu.AddItem(new MenuItem("NguoiChoiTest", "测试 自己的范围").SetValue(false));
            _menu.AddItem(new MenuItem("Active", "开 启").SetValue(false));
