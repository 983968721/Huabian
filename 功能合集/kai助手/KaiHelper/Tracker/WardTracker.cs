...
namespace KaiHelper.Tracker
{
    ...
    public class WardDetector
    {
        ...
        {
            MenuWard = config.AddSubMenu(new Menu("眼位 监测","WardTracker"));
            MenuWard.AddItem(new MenuItem("WardScale", "大 小")).SetValue(new Slider(70));
            MenuWard.AddItem(new MenuItem("WardActive", "开 启")).SetValue(true);
