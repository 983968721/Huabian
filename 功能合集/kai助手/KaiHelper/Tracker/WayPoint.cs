...
namespace KaiHelper.Tracker
{
    internal class WayPoint
    {
        ...
        public WayPoint(Menu menu)
        {
            ...
            _menu = menu.AddSubMenu(new Menu("路径 显示", "WaypointTracker"));
            _menu.AddItem(new MenuItem("AWPMiniMap", "小地图 显示").SetValue(false));
            _menu.AddItem(new MenuItem("AWPMap", "开 启").SetValue(false));
