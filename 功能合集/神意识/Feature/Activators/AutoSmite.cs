        ...
        private void ActivatorsLoaded(object o)
        {
            try
            {
                if (o is Activators && (o as Activators).Menu != null)
                {
                    ...
                    var spellsMenu = new Menu("法 术", Name + "Spells");
                    spellsMenu.AddItem(new MenuItem(Name + "SpellsSmite", "使用 惩戒").SetValue(true));
                    spellsMenu.AddItem(new MenuItem(Name + "SpellsNunu", "使用 努努 Q").SetValue(true));
                    spellsMenu.AddItem(new MenuItem(Name + "SpellsChogath", "使用 科加斯 R").SetValue(true));
                    spellsMenu.AddItem(new MenuItem(Name + "SpellsOlaf", "使用 奥拉夫 E").SetValue(true));

                    var drawingMenu = new Menu("范 围", Name + "Drawing");
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingUseableColor", "可用 颜色").SetValue(Color.Blue));
                    drawingMenu.AddItem(
                        new MenuItem(Name + "DrawingUnusableColor", "不可用 颜色").SetValue(Color.Gray));
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingDamageColor", "伤害 颜色").SetValue(Color.SkyBlue));
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingSmiteRange", "惩戒 范围").SetValue(true));
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingHeroSpellsRange", "英雄 技能 范围").SetValue(true));
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingDamageTillSmite", "惩戒 伤害").SetValue(true));

                    Menu.AddSubMenu(spellsMenu);
                    Menu.AddSubMenu(drawingMenu);

                    Menu.AddItem(new MenuItem(Name + "BigCamps", "大 Camps").SetValue(true));
                    Menu.AddItem(new MenuItem(Name + "SmallCamps", "小 Camps").SetValue(false));
//                    Menu.AddItem(new MenuItem(Name + "PacketCasting", "Packet Casting").SetValue(false));
                    Menu.AddItem(
                        new MenuItem(Name + "Enabled", "开 启").SetValue(new KeyBind('N', KeyBindType.Toggle, true)));
