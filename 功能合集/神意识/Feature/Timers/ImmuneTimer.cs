        ...
        private void TimersLoaded(object o)
        {
            try
            {
                if (o is Timers && (o as Timers).Menu != null)
                {
                    ...
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingAllyColor", "友军 颜色").SetValue(Color.DarkRed));
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingEnemyColor", "敌方 颜色").SetValue(Color.DarkRed));

                    Menu.AddSubMenu(drawingMenu);

                    Menu.AddItem(new MenuItem(Name + "ShowAlly", "显示 友军").SetValue(true));
                    Menu.AddItem(new MenuItem(Name + "ShowEnemy", "显示 敌军").SetValue(true));
