...
namespace Support.Plugins
{
    ...
    public class Braum : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("Combo.R.Count", "对多少敌人使用 R", 2, 1, 5);
        }
        ...
        {
            config.AddBool("Misc.Shield.Skill", "使用坚韧不催 抵擋", true);
            config.AddBool("Misc.Shield.Target", "使用坚韧不催 目標", true);
            config.AddSlider("Misc.Shield.Health", "使用坚韧不催抵挡平A 最低HP", 30, 1, 100);
        }
