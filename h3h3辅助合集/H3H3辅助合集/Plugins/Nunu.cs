...
namespace Support.Plugins
{
    ...
    public class Nunu : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("Combo.Q.Health", "低于 %HP 使用 Q", 50, 1, 100);
        }
        ...
        public override void HarassMenu(Menu config)
        {
            ...
            config.AddSlider("Harass.Q.Health", "血量低于 %HP 使用 Q", 50, 1, 100);
        }

        public override void MiscMenu(Menu config)
        {
            config.AddList("Misc.Laugh", "嘲 讽", new[] { "OFF", "ON", "ON + Mute" });
            config.AddBool("Misc.E.NoFace", "正面 E ", false);
        }

        public override void InterruptMenu(Menu config)
        {
            config.AddBool("Gapcloser.E", "使用 E 阻止 突进", true);
        }
    }
}