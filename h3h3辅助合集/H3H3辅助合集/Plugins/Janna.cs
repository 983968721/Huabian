...
namespace Support.Plugins
{
    ...
    public class Janna : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("Combo.R.Health", "使用 R 回血", 15, 1, 100);
        }
        ...
        public override void MiscMenu(Menu config)
        {
            ...
            // build aa menu
            var aa = config.AddSubMenu(new Menu("进攻 时 使用 E", "Misc.E.AA.Menu"));
            ...
            // build spell menu
            var dmg = config.AddSubMenu(new Menu("使用 E 抵挡技能", "Misc.E.Spell.Menu"));
        ...
        {
            config.AddSlider("Mana.E.Priority.1", "优先使用 E 1", 65, 0, 100);
            config.AddSlider("Mana.E.Priority.2", "优先使用 E  2", 35, 0, 100);
            config.AddSlider("Mana.E.Priority.3", "优先使用 E 3", 10, 0, 100);
        }

        public override void InterruptMenu(Menu config)
        {
            config.AddBool("Gapcloser.Q", "使用 Q 阻止 突进", true);
            config.AddBool("Gapcloser.W", "使用 W 阻止 突进", true);

            config.AddBool("Interrupt.Q", "使用 Q 打断 技能", true);
            config.AddBool("Interrupt.R", "使用 R 打断 技能", true);
        }
    }
}