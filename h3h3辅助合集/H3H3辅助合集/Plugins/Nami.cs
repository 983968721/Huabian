...
namespace Support.Plugins
{
    ...
    public class Nami : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("ComboCountR", "敌人在范围內", 2, 1, 5);
        ...
        public override void HarassMenu(Menu config)
        {
            ...
            config.AddSlider("HarassHealthW", "骚扰 W補血", 20, 1, 100);
        }

        public override void MiscMenu(Menu config)
        {
            var sub = config.AddSubMenu(new Menu("进攻时 使用 E", "Misc.E.AA.Menu"));
        ...
        {
            config.AddBool("GapcloserQ", "使用 Q 阻止 突进", true);
