    ...
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>DevRyze Loaded v{0}汉化By花边</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        private static void InitializeMainMenu()
        {
            ...
            Config = new Menu("花边汉化-DEV瑞兹", "DevRyze", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("ComboKey", "开 启!").SetValue(new KeyBind(Config.Item("Orbwalk").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseAACombo", "连招时丨使用平A").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRComboToggle", "使用 R (自动)").SetValue(new KeyBind("G".ToCharArray()[0], KeyBindType.Toggle)));

            Config.AddSubMenu(new Menu("骚 扰", "Harass"));
            Config.SubMenu("Harass").AddItem(new MenuItem("HarassKey", "开 启!").SetValue(new KeyBind(Config.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("UseHarassAlways", "保持 骚扰 开启").SetValue(false));

            Config.AddSubMenu(new Menu("追 人", "Chase"));
            Config.SubMenu("Chase").AddItem(new MenuItem("ChaseKey", "开 启!").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Chase").AddItem(new MenuItem("UseWChase", "使用 W").SetValue(true));
            Config.SubMenu("Chase").AddItem(new MenuItem("UseFullComboAfterChase", "打出一套后再用 W").SetValue(true));

            Config.AddSubMenu(new Menu("清 线", "LaneClear")); 
            Config.SubMenu("LaneClear").AddItem(new MenuItem("LaneClearKey", "开 启!").SetValue(new KeyBind(Config.Item("LaneClear").GetValue<KeyBind>().Key, KeyBindType.Press)));
            Config.SubMenu("LaneClear").AddItem(new MenuItem("UseLaneClearLastHit", "只补 最后一下").SetValue(false));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("ManaLaneClear", "清线丨最低蓝量").SetValue(new Slider(40, 1, 100)));

            Config.AddSubMenu(new Menu("控 线", "Freeze"));
            Config.SubMenu("Freeze").AddItem(new MenuItem("FreezeKey", "开 启!").SetValue(new KeyBind(Config.Item("LastHit").GetValue<KeyBind>().Key, KeyBindType.Press)));
            Config.SubMenu("Freeze").AddItem(new MenuItem("UseQFreeze", "使用 Q丨最后一下").SetValue(false));
            Config.SubMenu("Freeze").AddItem(new MenuItem("ManaFreeze", "使用Q丨最低蓝量").SetValue(new Slider(40, 1, 100)));

            Config.AddSubMenu(new Menu("杂 项", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("PacketCast", "使用 封包").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("TearExploit", "叠加 眼泪蓝量").SetValue(true));

            Config.AddSubMenu(new Menu("防 突进", "GapCloser"));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("BarrierGapCloser", "被突进时丨开启屏障").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WGapCloser", "被突进时丨使用W").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WInterruptSpell", "使用W丨打断法术").SetValue(true));
