...
namespace Syndra
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("Bbyyy汉化-辛德拉", ChampionName, true);
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseEFarm", "使用 E").SetValue(
                        new StringList(new[] { "控线", "清线", "同时", "禁止" }, 3)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("InterruptSpells", "中断 法术").SetValue(true));
            Config.SubMenu("Misc")
                .AddItem(
                    new MenuItem("CastQE", "QE 锁定的目标").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            Game.PrintChat(ChampionName + " Loaded!汉化-Bbyyy!");
        }
