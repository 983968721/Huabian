...
namespace Leblanc
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("Bbyyy汉化-妖姬", ChampionName, true);
            {
            ...
            {
                Config.SubMenu("Combo").AddItem(new MenuItem("ComboSetOption", "连招").SetValue(new StringList(new[] {"Auto", "Q-R Combo", "W-R Combo", "E-R Combo",}, 1)));
                Config.SubMenu("Combo").AddItem(new MenuItem("ComboSetEHitCh", "E 攻击").SetValue(new StringList(new[] {"Low", "Medium", "High", "Very High", "Immobile"}, 2)));
                Config.SubMenu("Combo").AddSubMenu(new Menu("禁止使用连招到", "DontCombo"));
                {
                ...
                Config.SubMenu("Combo").AddItem(new MenuItem("ComboDblStun", "双重 禁锢!").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                Config.SubMenu("Combo").AddItem(new MenuItem("ComboShowInfo", "显示连招等级").SetValue(true));
            ...
            Config.AddSubMenu(new Menu("骚扰", "Harass"));
            {
                ...
                Config.SubMenu("Harass").AddItem(new MenuItem("xHx", ""));
*/
                Config.SubMenu("Harass").AddSubMenu(new Menu("Q", "骚扰Q"));
                    Config.SubMenu("Harass").SubMenu("HarassQ").AddItem(new MenuItem("HarassUseQ", "使用 Q").SetValue(true));
                    Config.SubMenu("Harass").SubMenu("HarassQ").AddItem(new MenuItem("HarassManaQ", "Q 骚扰最低蓝量: ").SetValue(new Slider(50, 100, 0)));
                    Config.SubMenu("Harass").SubMenu("HarassQ").AddItem(new MenuItem("HarassUseTQ", "使用 Q (自动)!").SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
                Config.SubMenu("Harass").AddSubMenu(new Menu("W", "HarassW"));
                    ...
                    Config.SubMenu("Harass").SubMenu("HarassW").AddItem(new MenuItem("HarassManaW", "W 骚扰最低蓝量: ").SetValue(new Slider(50, 100, 0)));
                    Config.SubMenu("Harass").SubMenu("HarassW").AddItem(new MenuItem("HarassUseTW", "使用 W (自动)!").SetValue(new KeyBind("K".ToCharArray()[0], KeyBindType.Toggle)));
                Config.SubMenu("Harass").AddSubMenu(new Menu("E", "HarassE"));
                    ...
                    Config.SubMenu("Harass").SubMenu("HarassE").AddItem(new MenuItem("HarassManaE", "E 骚扰最低蓝量: ").SetValue(new Slider(50, 100, 0)));
                    Config.SubMenu("Harass").SubMenu("HarassE").AddItem(new MenuItem("HarassUseTE", "使用 E (自动)!").SetValue(new KeyBind("L".ToCharArray()[0], KeyBindType.Toggle)));
                
                Config.SubMenu("Harass").AddItem(new MenuItem("HarassShowInfo", "显示骚扰全部状态").SetValue(true));
            ...
            Config.AddSubMenu(new Menu("范围", "Drawings"));
            {
                ...
                Config.SubMenu("Drawings")
                    .AddItem(
                        new MenuItem("ActiveERange", "启动 E 范围").SetValue(new Circle(false, Color.GreenYellow)));
                Config.SubMenu("Drawings")
                    .AddItem(new MenuItem("WObjPosition", "W 目标 位子.").SetValue(new Circle(true, Color.GreenYellow)));
                Config.SubMenu("Drawings").AddItem(new MenuItem("WObjTimeTick", "W 目标 标记").SetValue(true));
                Config.SubMenu("Drawings")
