    ...
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                _config = new Menu("Bbyyy汉化-劫", "Ze-D Is Back", true);
                ...
                //Combo
                _config.AddSubMenu(new Menu("C连招", "Combo"));
                _config.SubMenu("Combo").AddItem(new MenuItem("UseWC", "使用 W (敌人突进)")).SetValue(true);
                _config.SubMenu("Combo").AddItem(new MenuItem("UseIgnitecombo", "使用 引燃(可击杀)")).SetValue(true);
                _config.SubMenu("Combo").AddItem(new MenuItem("ActiveCombo", "连招!").SetValue(new KeyBind(32, KeyBindType.Press)));
                _config.SubMenu("Combo")
                    .AddItem(new MenuItem("TheLine", "连招").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                ...
                _config.SubMenu("Harass").AddItem(new MenuItem("UseWH", "使徒 W")).SetValue(true);
                ...
                _config.SubMenu("items")
                    .SubMenu("Deffensive")
                    .AddItem(new MenuItem("Omenenemys", "兰顿丨敌人数量").SetValue(new Slider(2, 1, 5)));
                _config.SubMenu("items")
                    .SubMenu("Deffensive")
                ...
                _config.SubMenu("items")
                    .SubMenu("Deffensive")
                    .AddItem(new MenuItem("lotisminhp", "鸟盾丨队友血量").SetValue(new Slider(35, 1, 100)));
                ...
                _config.SubMenu("Farm")
                    .SubMenu("LaneFarm")
                    .AddItem(new MenuItem("Energylane", "清线丨最低蓝量").SetValue(new Slider(45, 1, 100)));
                _config.SubMenu("Farm")
                    .SubMenu("LaneFarm")
                    .AddItem(
                ...
                _config.SubMenu("Misc").AddItem(new MenuItem("rdodge", "自动R躲避危险")).SetValue(true);
                ...
                _config.SubMenu("Drawings").AddItem(new MenuItem("shadowd", "影子 位子")).SetValue(true);
                _config.SubMenu("Drawings").AddItem(new MenuItem("damagetest", "伤害 信息")).SetValue(true);
                _config.SubMenu("Drawings").AddItem(new MenuItem("CircleLag", "延迟 自由圈").SetValue(true));
                _config.SubMenu("Drawings")
                    .AddItem(new MenuItem("CircleQuality", "线圈丨薄厚").SetValue(new Slider(100, 100, 10)));
                _config.SubMenu("Drawings")
                    .AddItem(new MenuItem("CircleThickness", "线圈丨质量").SetValue(new Slider(1, 10, 1)));
